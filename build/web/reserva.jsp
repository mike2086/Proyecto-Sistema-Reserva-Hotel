...
<html class="no-js">
    ...
    <head>
        ...
        <meta name="description" content="Hotel Grand Castillo" />
                                        ...
                                        <div class="tabulation animate-box">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation">
                                                    <a href="#hotels" aria-controls="hotels" role="tab" data-toggle="tab">Reserva de Habitación</a>
                                                </li>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <form action="SvReserva" method="post">
                                                            ...
                                                            <div class="col-sm-12 mt ">
                                                                <section>
                                                                    <label for="class ">Id Habitación:</label>
                                                            ...
                                                            <div class="col-xxs-12 col-xs-12 mt">
                                                                <div class="input-field">
                                                                    <label for="from">Id Empleado:</label>
                                                                    <input type="text" class="form-control" id="idEmpleado" name="idEmpleado" />
                                                                </div>
                                                            </div>
                                                            <div class="col-xxs-12 col-xs-12 mt">
                                                                <div class="input-field">
                                                                    <label for="from">Id huesped:</label>
                                                                    <input type="text" class="form-control" id="idHuesped" name="idHuesped" />
                                                                </div>
                                                            </div>

                                                            <div class="col-xs-12 ">
                                                                <input type="submit" class="btn btn-primary btn-block" value="Crear Reserva">
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>

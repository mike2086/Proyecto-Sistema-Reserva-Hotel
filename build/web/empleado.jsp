                        ...
                        <div class="nav-header">
                            ...
                            <nav id="fh5co-menu-wrap" role="navigation">
                                <ul class="sf-menu" id="fh5co-primary-menu">
                                    ...
                                    <li class="active"><a href="empleado.jsp">Empleado</a></li>
                                        ...
                                        <div class="tabulation animate-box">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation">
                                                    <a href="#hotels" aria-controls="hotels" role="tab" data-toggle="tab">Alta Empleado</a>
                                                </li>
                                                ...
                                                <div role="tabpanel" class="tab-pane active" id="hotels">
                                                    <div class="row">
                                                        ...
                                                        <form action="SvEmpleado" method="post">
                                                            ...
                                                            <div class="col-xxs-12 col-xs-12 mt">
                                                                <div class="input-field">
                                                                    <input type="text" class="form-control" id="profesion" name="cargo" placeholder="Cargo" />
                                                                </div>
                                                            </div>
                                                            <div class="col-xxs-12 col-xs-12 mt">
                                                                <div class="input-field">
                                                            ...
                                                            <div class="col-xxs-12 col-xs-12 mt">
                                                                <div class="input-field">
                                                                    <label for="from">Contraseña:</label>
                                                                    <input type="text" class="form-control" id="contrsenia" name="contrasenia" placeholder="Contraseña" />
                                                                </div>
                                                            </div>

                                                            <div class="col-xs-12">
                                                                <input type="submit" class="btn btn-primary btn-block" value="Crear Empleado">
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
